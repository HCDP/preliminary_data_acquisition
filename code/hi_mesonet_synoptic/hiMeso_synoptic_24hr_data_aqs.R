...
rawOutDir<-paste0(mainDir,"/data_aqs/data_outputs/hi_mesonet_synoptic/raw")
parseOutDir<-paste0(mainDir,"/data_aqs/data_outputs/hi_mesonet_synoptic/parse")
...
if(nrow(allMesoData)>0){
  setwd(parseOutDir)
  write.csv(allMesoData,paste0(dataDateName,"_hi_mesonet_synoptic_parsed.csv"),row.names = F)
